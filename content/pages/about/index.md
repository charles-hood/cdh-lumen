...
<div class="agent-container">
  ...
  <div style="margin-left: 0; overflow: hidden;">
    ...
    <label for="read-more-checkbox-1" class="read-more-link">Read More</label>
    <input type="checkbox" id="read-more-checkbox-1" class="read-more-checkbox">
  </div>
</div>
...
<div class="agent-container">
  ...
  <div style="margin-left: 0; overflow: hidden;">
    ...
    <label for="read-more-checkbox-2" class="read-more-link">Read More</label>
    <input type="checkbox" id="read-more-checkbox-2" class="read-more-checkbox">
  </div>
</div>
...
<div class="agent-container">
  ...
  <div style="margin-left: 0; overflow: hidden;">
    ...
    <label for="read-more-checkbox-3" class="read-more-link">Read More</label>
    <input type="checkbox" id="read-more-checkbox-3" class="read-more-checkbox">
  </div>
</div>
